...
function App() {
  return (
   <div className='bg-[#DEDEDC] w-full flex p-3 gap-5'>
    ...
    <div className="w-1/5 h-[100vh] bg-[#798991] rounded-xl ">
         <p className='text-8xl text-center mt-5 text-white'>RSA</p>
         <div className='text-center mt-[100px] text-xl gap-5'>
          <ul className='gap-5 '>
    ...
    <div className=' w-4/5 w-full rounded-xl gap-5'>
      <div className='w-full bg-[#F3F4F6] h-[10%] rounded-xl p-3 flex'>
        ...
        <div className='w-2/3 justify-end items-center flex '>

            <img class="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500 object-cover" src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D" alt="Bordered avatar" />
      ...
      <div className=' w-full h-[10%] flex items-center'>
          <h2 className='text-xl ml-3'>Dashboard / Stocks / Runner Bolt</h2>
      </div>
      <div className='w-full bg-[#F3F4F6] h-[73%]  rounded-xl p-3'>
        <div>
        ...
        <div className=' flex gap-5'>
            ...
            <div className="w-full">
              ...
              <div className='flex justify-between mt-5'>
                ...
                <div className=''>
                  <div className='text-3xl border-b-2 border-gray-400'>Size</div>
                ...
                <div className=''>
                  <div className='text-3xl border-b-2 border-gray-400'>Availibility</div>
                  <div className='text-2xl mt-3 text-center'>
                    <p>75</p>
                    <p>106</p>
                    <p>167</p>
                ...
                <div className=''>
                  <div className='text-3xl border-b-2 border-gray-400'>Color</div>
                  <div className='text-2xl mt-3 text-center'>
                    <p>5</p>
                    <p>6</p>
                    <p>7</p>
